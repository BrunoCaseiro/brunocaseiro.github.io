...
feroxbuster -u <url> -w /usr/share/wordlists/seclists/Discovery/Web-Content/raft-combined.txt -x asp,aspx,bak,txt,html,php,rar,zip,git,env,py,json,conf,yaml,js -t 50
