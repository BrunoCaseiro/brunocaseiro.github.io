...
My guess would be that for a very large number of files, the execution delta will eventually be closer and closer to the deletion delta, and eventually be lower than it. I didn't try with more than 300k files as the copy takes a long time, but that was enough so that the exploit worked.
